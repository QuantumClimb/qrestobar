      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#371018] border border-[#C69A4B]/30 p-5 sm:p-6 rounded-sm shadow-xl space-y-3 sm:space-y-4 relative static sm:static z-10 w-full max-w-full min-w-0">
              <h3 className="text-xs font-semibold uppercase tracking-[0.16em] text-[#C69A4B] flex items-center gap-2 w-full max-w-full min-w-0">
                <Clock className="w-4 h-4 text-[#E89532] shrink-0" />
                <span>Service Hours</span>
              </h3>

              <div className="space-y-2 text-xs text-[#F8EAD2]/80 font-light leading-relaxed w-full max-w-full min-w-0 whitespace-normal [overflow-wrap:anywhere]">
                <p className="text-[#FFF4DF] font-medium text-xs sm:text-sm w-full max-w-full min-w-0 whitespace-normal [overflow-wrap:anywhere]">
                ...
                <p className="text-[11px] text-[#E89532] pt-1 w-full max-w-full min-w-0 whitespace-normal [overflow-wrap:anywhere]">
