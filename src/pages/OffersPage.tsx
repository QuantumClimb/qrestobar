...
const BotanicalBistroOffers = React.lazy(
  () => import('../themes/components/botanicalBistro/BotanicalBistroOffers')
);
const UrbanNeonOffers = React.lazy(
  () => import('../themes/components/urbanNeon/UrbanNeonOffers')
);
